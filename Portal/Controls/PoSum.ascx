...
<table width="100%" cellpadding="0">
    <tr>
        <td class="buttonlabel">Fulfillment Summary</td>
    </tr>
    <tr>
        <td>
            <asp:Panel ID="pnlSummary" runat="server">
             <table width="100%" border="0">
                    ...
                    <tr align="left">
                        ...
                        <td width="70%" align="left"><b> <asp:Label ID="lblTotalPOs"  CssClass="copy10grey" runat="server"></asp:Label></b></td>
                    </tr>
<tr align="left">
                        <td align="left" class="copy10grey" width="22%" >Total Quantity of Units:</td>
                        <td width="70%" align="left"><asp:Label ID="lblUnits"  CssClass="copy10grey" runat="server"></asp:Label></td>
                    </tr>
                    <%--<tr>
    ...
    <tr><td class="buttonlabel">Inventory Summary</td>
    </tr>
    <tr>
        <td class="copy10grey">
