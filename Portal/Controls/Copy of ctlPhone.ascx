...
<table cellSpacing="0" cellPadding="0" width="775" align="center" border="0">
	<tr>
		<td class="bgleft" vAlign="top" width="200"><br>
			...
			<div align="center"><br>
				<table width="100%" border="0">
					...
					<tr>
						<td class="copy11" style="HEIGHT: 14px" vAlign="top" colSpan="2"><strong><font class="txt_4_b"><asp:dropdownlist id="dpType" Width="100%" name="dpType" Runat="server" onchange="return fnSelectSortBy()"></asp:dropdownlist></font></strong></td>
					</tr>
					<tr>
						<td style="HEIGHT: 17px"><strong><font class="txt_4_b"><asp:dropdownlist id="dpManuf" Width="100%" name="dpManuf" Runat="server" onchange="return fnSelectSortBy()"></asp:dropdownlist></font></strong></td>
					</tr>
					<tr>
						<td><strong><font class="txt_4_b"><asp:dropdownlist id="dpSP" Width="100%" name="dpSP" Runat="server" onchange="return fnSelectSortBy()"></asp:dropdownlist></font></strong></FONT></td>
					</tr>
				</table>
			</div>
			<br>
		...
		<td vAlign="top">
			<table width="100%" border="0">
				<tr>
					<td vAlign="top" align="center"><asp:datalist id="dl" Width="100%" runat="server">
							<ItemTemplate>
													...
													<td>
														<TABLE cellSpacing="1" cellPadding="1" width="100%" border="0">
															<TR>
																...
																<TD width="94">
																	<div align="center" w>
																		<a  href='LstDist.aspx?pid=<%#DataBinder.Eval(Container.DataItem,"Itemid")%>' ><img  border="0" src='<%#DataBinder.Eval(Container.DataItem,"PhoneImage")%>'/>
																...
																<TD vAlign="top">
																	<TABLE cellSpacing="1" cellPadding="1" width="100%" border="0">
																		...
																		<TR>
																			...
																			<TD align="right"><a  href='LstDist.aspx?pid=<%#DataBinder.Eval(Container.DataItem,"Itemid")%>' ><img border="0" src="./images/buybt.gif" /></a></a>
																			</TD>
																		</TR>
																	</TABLE>
																</TD>
