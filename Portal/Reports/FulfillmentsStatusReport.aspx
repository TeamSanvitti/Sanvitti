     ...
     <table width="100%" border="0" class="box" align="center" cellpadding="2" cellspacing="2">
         ...
         <td style="height:1px"></td>
            ...
            <tr valign="top">
                ...
                <td width="35%">
                <asp:DropDownList ID="dpCompany" runat="server" AutoPostBack="false" Width="70%"
                 class="copy10grey">
                </asp:DropDownList> 
                    ...
                    <%--<asp:Panel ID="pnlPO" runat="server">--%>
                        ...
                        <HeaderStyle  CssClass="buttonlabel" ForeColor="white"/>
                          ...
                          <Columns>
                                ...
                                <asp:TemplateField HeaderText="Customer Name" ItemStyle-CssClass="copy10grey"  ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Left" >
                                    <ItemTemplate>
                                     <div style="width:100%;  font-weight:<%# Convert.ToString(Eval("CustomerName")) == "zzTotal"? "bold":"normal" %>; background-color:<%# Convert.ToString(Eval("CustomerName")) == "zzTotal"? "yellow":"" %>; height:20px">
                                        ...
                                        <%# Convert.ToString(Eval("CustomerName")) == "zzTotal" ? "Fulfilment Order Total" : Eval("CustomerName")%>
                                        </asp:LinkButton>                                           
                                ...
                                <asp:TemplateField HeaderText="Fulfilment Order Total" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="copy10grey" ControlStyle-BackColor="Yellow" ItemStyle-Width="5%">
                                    <ItemTemplate>
                        ...
                        <asp:Panel ID="pnlPoSku" runat="server">
                        <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="buttonlabel" align="left">
                                Fulfillment SKUs statuses
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gvPOSKU" OnPageIndexChanging="gvPOSKU_PageIndexChanging"    AutoGenerateColumns="false"  
                        Width="100%" ShowHeader="true"  ShowFooter="false" runat="server" GridLines="Both" 
                        PageSize="100" AllowPaging="true" AllowSorting="false" 
                        >
                        <RowStyle BackColor="Gainsboro" />
                        <AlternatingRowStyle BackColor="white" />
                        <HeaderStyle  CssClass=buttonlabel ForeColor="white"/>
                          ...
                          <Columns>
                                <asp:TemplateField HeaderText="S.No." ItemStyle-CssClass="copy10grey"  ItemStyle-Width="2%"  ItemStyle-HorizontalAlign="Right">
                                    <ItemTemplate>
                                          ...
                                          <%# Convert.ToString(Eval("SKU")) == "zzTotal" ? "" : Convert.ToString(Container.DataItemIndex + 1)%> &nbsp;
                                    </ItemTemplate>
                                </asp:TemplateField>                 
        
                                <asp:TemplateField HeaderText="SKU#" ItemStyle-CssClass="copy10grey"  ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Left" >
                                    <ItemTemplate>
                                     <div style="width:100%;  font-weight:<%# Convert.ToString(Eval("SKU")) == "zzTotal"? "bold":"normal" %>; background-color:<%# Convert.ToString(Eval("SKU")) == "zzTotal"? "yellow":"" %>; height:20px">
                                    <%# Convert.ToString(Eval("SKU")) == "zzTotal" ? "Fulfilment SKUs Total" : Eval("SKU")%>
<%--
                                    <asp:LinkButton ID="lnkPos" CommandArgument='<%# Eval("SKU") %>' OnCommand="lnkPOStatus_OnCommand" runat="server">
                                    <%# Convert.ToString(Eval("SKU")) == "zzTotal" ? "Total" : Eval("SKU")%>
                                    </asp:LinkButton>--%>
                                ...
                                <asp:TemplateField HeaderText="Fulfilment SKUs Total" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="copy10grey" ControlStyle-BackColor="Yellow" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                        <div style="width:100%;  font-weight:<%# Convert.ToString(Eval("SKU")) == "zzTotal"? "bold":"normal" %>; background-color:yellow; height:20px">
                                    &nbsp;
                                   <b> <%# Eval("Total")%>   </b>
                                    <%--<a class="copy10grey" href='FulfillmentsStatusReport.aspx?pos=<%# Eval("PartialProcessed")%>&t=<% =TimeInterval%>&cid=<%# Eval("CompanyID")%>'> 
                                    --%>
                                ...
                                <asp:Label ID="lblPOsku" runat="server" CssClass="errormessage"></asp:Label>
