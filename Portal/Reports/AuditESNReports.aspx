<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditESNReports.aspx.cs" Inherits="avii.Reports.AuditESNReports" %>
     ...
     <td width="30%">
        ...
        <td  width="40%">
            ...
            <tr>
                ...
                <td>
                <asp:TextBox ID="txtEndDate"   CssClass="copy10grey" runat="server" Width="70%" MaxLength="12" ></asp:TextBox>
