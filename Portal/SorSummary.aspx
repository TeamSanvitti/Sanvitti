<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SorSummary.aspx.cs" Inherits="avii.SorSummary" %>
...
<head runat="server">
    ...
    <script>
        function InitializeRequest(requestID) {
            ...
            var url = "../ServiceOrderRequest.aspx";
            window.open(url);
        }
...
<body  bgcolor="#ffffff" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table cellspacing="0" cellpadding="0" border="0" align="center" style="text-align:left" width="95%">
        ...
        <td>&nbsp;Service Order Request Summary</td></tr>
    </table>
    <table cellspacing="0" cellpadding="0" border="0" align="center" style="text-align:left" width="95%">
        <tr>
            <td>
