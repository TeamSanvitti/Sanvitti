...
namespace avii
{
    public partial class POB2C : System.Web.UI.Page
    {
        ...
        private InventoryList GetInventoryItems(int userID, int sim)
        {
            ...
            {
                if (sim == -1)
                    InventoryOperation.GetInventoryItems(userID, sim, 0);
                else
        ...
        //{
        //    clsPurchaseOrder po = new clsPurchaseOrder();
        ...
        private bool ValidateSave()
        {
            ...
            //if (companyID == 470)
            //{
            //    if (string.IsNullOrEmpty(txtFactOrderNumber.Text.Trim()))
            //    {
            //        success = false;
            //        errormessage = "Fact order number is required";
            //    }
            //}
            ...
            if (userid > 0)
            {
                ...
                if (ViewState["ItemCodeError"] == null)
                {
                    if (ViewState["qty"] == null)
                    {
                        ...
                        {
                            // txtRequestedshipdate.Text = "2020-06-30";
                            //txtPoDate.Text = "2020-06-25";
                            ...
                            purchaseOrder.StoreID = string.Empty;
        ...
        protected void ddlCustomer_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (companyInfo != null && companyInfo.UserID > 0)
            {
                ...
                ViewState["POCustNoValidate"] = companyInfo.POCustNoValidate;
