...
namespace avii.Classes
{
    ...
    public class RoleUtility
    {
        ...
        public int createRole(int roleID, string roleName, int userID, bool active)
        {
            int roleid = 0;
        ...
        public List<Roles> getRoleList(int roleGUID, string roleName, bool active, string moduleid, int uniqueflag)
        {
