<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SimPO.aspx.cs" Inherits="avii.SimPO" %>
...
<head id="Head1" runat="server">
        <title>Manage SIM Fulfillment</title>
...
<td align="left">
                    ...
                    <td>
                        ...
                        <asp:Panel ID="pnlItemCode" runat="server" CssClass="modalItemCode"  >
                ...
                <tr><td class="button"  ><strong> Select SKU</strong></td>
