<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RMAForm.aspx.cs" Inherits="avii.Admin.RMA.RMAForm" ValidateRequest="false"  %>
...
<body bgcolor="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" style="text-align: center" width="100%" onkeydown="if (event.keyCode==13) {event.keyCode=9; return event.keyCode }">
       ...
       <table cellspacing="0" cellpadding="0" border="0"  width="100%" align="center">
        <tr>
            <td>
               <head1:MenuHeader1 ID="MenuHeader" runat="server"></head1:MenuHeader1>         
                <menu:menu ID="HeadAdmin" runat="server" ></menu:menu>
            </td>
        </tr> 
        </table> 
        ...
        <tr>
            <td>
                ...
                - Atleast one ESN is assigned to RMA before Submission.</td></tr>
    </table>
                   </td>
                   </tr>
                    <tr>
                    ...
                    <td>
                       <table bordercolor="#839abf" border="1" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr >
                            ...
                            <td  >
                                <asp:TextBox ID="txtRmaNum" runat="server" 
                                    CssClass="copy10grey" MaxLength="15" Width="166px" ReadOnly="True" Enabled="false" />
                            </td>
                            <td class="copy10grey" ><asp:Label ID="lblRMADate" runat="server" Text="RMA Date:"  CssClass="copy10grey"></asp:Label>
                                <asp:Label ID="lblrmadate_md" runat="server" CssClass="errormessage">*</asp:Label></td>
                            <td width="166px">
                            ...
                            <td Class="copy10grey" Width="166px">
                                ...
                                <asp:DropDownList ID="ddlStatus"  runat="server" Class="copy10grey" Width="166px">
                        ...
                        <tr>
                            <td   class="copy10grey"  align="left">Customer Name:</td>
                            <td colspan="5">
                        ...
                        <tr>
                            <td   class="copy10grey"  align="left">Address:</td>
                            <td colspan="5">
                                <asp:TextBox ID="txtAddress" runat="server" CssClass="copy10grey" Width="90%" MaxLength="200"/>
                            </td>                            
                        </tr>
                        <tr>
                            <td   class="copy10grey"  align="left">City:</td>
                            <td>
                                <asp:TextBox ID="txtCity" runat="server" CssClass="copy10grey" MaxLength="50"/>
                            </td>                            
                            <td class="copy10grey"  align="left">State:</td>
                            <td>
                                <asp:TextBox ID="txtState" runat="server" CssClass="copy10grey" MaxLength="30" />
                             </td>
                             <td class="copy10grey"  align="left">Zip:</td>    
                              <td>  <asp:TextBox ID="txtZip" runat="server" CssClass="copy10grey" MaxLength="5"/>
                            </td>  
                        </tr>
                ...
                <table id="rmadetail"  cellspacing="0" cellpadding="0" width="100%" style="text-align: center" >                
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table width="100%" Class="copy10grey" align="center">
                                <tr>
                                    <td id="td_esn" align="left">
                                        ...
                                        <asp:DataList ID="Dl_rma_detail" runat="server" OnItemDataBound="DataList1_ItemDataBound">
                                            <HeaderTemplate >
                                            <table  cellpadding="1" cellspacing="1" border="0">
                                            <tr style="height: 20px" valign="top">
                                                <td class="button" Width="20px">&nbsp;</td>
                                                <td class="button" Width="225px" align="left">ESN</td>
                                                <td class="button" Width="149px"  align="left">UPC</td>
                                               <%-- <td class="button" Width="90px"  align="left">Brand</td>--%>
                                                <td class="button" Width="30px"  align="left" id="tdCallTime">Call Time</td>
                                                <td class="button" Width="100px"  align="left" id="tdReason">Reason</td>
                                                
                                                 <td class="button" Width="240px"  align="left" id="tdnotes">Notes</td>
                                                <td  > 
                                                    <asp:Label ID="lblStatusheader" runat="server" Text="Status" Width="168px" Height="35px" CssClass="button"></asp:Label>
                                                            </td>
                                            </tr>
                                            </table>
                                            </HeaderTemplate>
                                                ...
                                                <table >
                                                    <tr id="trCallTimerow" valign="bottom">
                                                        ...
                                                        <td >
                                                         ...
                                                         <asp:TextBox ID="txt_ESN" Text = '<%# Eval("esn") %>'  runat="server"  Width="222px" onkeypress="return alphaNumericCheck(event);"  
                                                        ...
                                                        <td >
                                                            ...
                                                            <asp:Label ID="lblItemCode" Text = '<%# Eval("UPC") %>'  CssClass="copy10grey" Width="145px" runat="server"></asp:Label>
                                                        </td>
                                                       
                                                        <td >
                                                            <asp:TextBox ID="txtCallTime" Width="30px" Text='<%# Eval("CallTime") %>'  onkeypress="return isNumberKey(event);"  CssClass="copy10grey" runat="server" MaxLength="3"></asp:TextBox>
                                                            <asp:HiddenField id="hdnPod_id" runat="server" Value='<%# Eval("pod_id") %>'/>
                                                            
                                                            <asp:HiddenField id="hdnlblItemCode" runat="server" Value='<%# Eval("UPC") %>'/>
                                                            
                                                        </td >
                                                        
                                                          <td >
                                                              <asp:DropDownList ID="ddReason" CssClass="copy10grey" runat="server" Width="100px" >
                                                              </asp:DropDownList>
                                                              <asp:HiddenField id="hdnReason" runat="server" Value='<%# Eval("Reason") %>'/>
                                                            </td>
                                                            
                                                            <td >
                                                                <asp:TextBox ID="txtNotes" onkeypress="return isMaxLength(this);"  Text='<%# Eval("Notes") %>'  Width="240px" CssClass="copy10grey" runat="server" MaxLength="1000" TextMode="MultiLine"></asp:TextBox>
                                                           </td>
                                                           <td>
                                                                 <asp:DropDownList ID="ddl_Status"  runat="server" Class="copy10grey" Width="166px">
                                                                    <asp:ListItem  Value="0" >------</asp:ListItem>
