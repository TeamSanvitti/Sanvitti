<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageRMAUpload.aspx.cs" Inherits="avii.RMA.ManageRMAUpload" %>
                        ...
                        <tr>
                            <td colspan="5"> 
                                ...
                                <tr id="trCustomer" runat="server">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="dpCompany" CssClass="copy10grey" OnSelectedIndexChanged="dpCompany_SelectedIndexChanged" 
                                           AutoPostBack="true" runat="server" Width="90%">
								        </asp:DropDownList>
                                ...
                                <tr >
                                    ...
                                    <td>
                                            ...
                                            <asp:DropDownList ID="ddlWarrenty2"  runat="server" class="copy10grey"  OnSelectedIndexChanged="ddlWarrenty2_SelectedIndexChanged"
                                   ...
                                   Reason:
                                    ...
                                    <td>
                                         <asp:DropDownList ID="ddlReason2" CssClass="copy10grey" runat="server" Width="60%"
                                             OnSelectedIndexChanged="ddlReason2_SelectedIndexChanged" AutoPostBack="true">
                                               <asp:ListItem  Value="0" >------</asp:ListItem>
                                ...
                                <tr id="trStatus2" runat="server" visible="false">
                                    ...
                                    <td>
                                            ...
                                            <asp:DropDownList ID="ddlDisposition"  runat="server" class="copy10grey" 
                                                Width="166px" OnSelectedIndexChanged="ddlDisposition_SelectedIndexChanged" AutoPostBack="true">
                                                <asp:ListItem  Value="0" >------</asp:ListItem>
                                   ...
                                   Line Item Status:
                                    ...
                                    <td>
                                         <asp:DropDownList ID="ddlLineStatus" CssClass="copy10grey" runat="server" Width="60%"
                                             OnSelectedIndexChanged="ddlLineStatus_SelectedIndexChanged" AutoPostBack="true">
								        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <asp:Repeater ID="rptRma" runat="server" OnItemDataBound="rptRma_ItemDataBound">
                                    ...
                                    <tr class="<%# Container.ItemIndex % 2 == 0 ? "alternaterow" : "" %>">
                                        ...
                                        <td class="copy10grey">
                                            ...
                                            <asp:HiddenField ID="hdPOID" Value='<%# Eval("PO_ID") %>' runat="server" />
