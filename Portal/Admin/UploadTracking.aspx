<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadTracking.aspx.cs" Inherits="avii.Admin.UploadTracking" %>
			            ...
			            <table id="Table2" cellSpacing="5" cellPadding="5" width="100%" border="0">
                            ...
                            <tr id="trShipFile" >
                                ...
                                <td class="copy10grey" align="left">
                                   <b>PoNum,TrackingNumber</b>,avOrderNumber
                                </td>
                             </tr>
                             ...
                             <tr>
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr valign="bottom"  class="<%# Container.ItemIndex % 2 == 0 ? "alternaterow" : "" %>">
                                        ...
                                        <td valign="bottom" class="copy10grey"  style="background-color:<%# Convert.ToString(Eval("ShipToTrackingNumber")) == "" ? "red" : ""%>">
                                        <span width="100%">
                                            <%# Eval("ShipToTrackingNumber")%>    
                                            </span>
                                        </td>
                                        <td valign="bottom" class="copy10grey"  >
                                        <span width="100%">
                                            <%# Eval("SalesOrderNumber")%>    
                                            </span>
                                        </td>
