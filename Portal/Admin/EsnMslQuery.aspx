<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EsnMslQuery.aspx.cs" Inherits="avii.Admin.EsnMslQuery" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="3%" HeaderStyle-CssClass="buttonlabel" HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:ImageButton ID="imgEdit" runat="server" ToolTip="Edit" AlternateText="View/Edit" 
                                                            OnCommand="imgEdit_Command" CommandArgument='<%# Eval("ESNHeaderId") %>' src="../images/edit.png" />
                                                    </div>
