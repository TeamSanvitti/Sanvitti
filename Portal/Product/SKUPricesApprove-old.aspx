...
<head id="Head1" runat="server">
    <title>Aerovoice Inc. - Approve SKU Prices</title>
...
<body  bgColor="#ffffff" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table  cellSpacing="1" cellPadding="1" width="100%">
        <tr>
		    <td colSpan="6" bgcolor="#dee7f6" class="button">&nbsp;&nbsp;Approve SKU Prices
		    </td>
        </tr>
			            ...
			            <table  cellSpacing="5" cellPadding="5" width="100%" border="0">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                             ...
                             <tr>
                                ...
                                <asp:GridView ID="gvSKUPrice" runat="server" Width="80%" GridLines="Both"   AutoGenerateColumns="false"
                                    ...
                                    >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SKU Last Price($)"   ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="copy10grey" ItemStyle-Width="15%">
                                                <ItemTemplate>
<%--<%# Convert.ToInt32(Eval("SKULastPrice")) > 0 ?  Eval("SKULastPrice", "{0:n}") : "" %>--%>
                                            ...
                                            <asp:TemplateField HeaderText="Propose Price($)"   ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="copy10grey" ItemStyle-Width="15%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPrice" CssClass="copy10grey" Width="90%"  Text='<%# Convert.ToInt32(Eval("SKUPrice")) > 0 ? "$ " + Eval("skuPrice", "{0:n}") : "" %>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField> 
