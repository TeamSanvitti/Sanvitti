...
(function (window, undefined) {
    ...
    jQuery.fn.extend({
        ...
        // http://blindsignals.com/index.aspx/2009/07/jquery-delay/
                ...
                return {
                    send: function (headers, complete) {
                        ...
                        callback = function (_, isAbort) {
                            ...
                            // http://helpful.knobs-dials.com/index.aspx/Component_returned_failure_code:_0x80040111_(NS_ERROR_NOT_AVAILABLE)
                            try {
