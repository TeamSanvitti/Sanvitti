<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POKitting.aspx.cs" Inherits="avii.POKitting" %>
              ...
              <br />
                <table  width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td align="left" >
                            <asp:Label ID="lblKittedSKU11" runat="server" CssClass="copy10grey"></asp:Label>
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                 <tr>
                                    ...
                                    <td  align="center">
                                        ...
                                        &nbsp;
                                        <asp:Button ID="btnKittingWithSamePO" Visible="true" CssClass="button" runat="server" OnClick="btnKittingWithSamePO_Click" Text="Kitting With Same PO" />
                                        &nbsp;
                                        <asp:Button ID="btnKittingWithNewPO_Click" Visible="true" CssClass="button" runat="server" OnClick="btnKittingWithNewPO_Click_Click" Text="Kitting With New PO" />
