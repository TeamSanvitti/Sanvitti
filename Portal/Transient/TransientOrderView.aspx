<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransientOrderView.aspx.cs" Inherits="avii.Transient.TransientOrderView" %>
        ...
        <HeaderStyle  CssClass="buttongrid" ForeColor="white"/>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Product Name" SortExpression="ProductName"  HeaderStyle-CssClass="buttongrid"   ItemStyle-HorizontalAlign="Left" 
                 ...
                 <asp:TemplateField HeaderText="Received Date" SortExpression="ReceivedDate"  HeaderStyle-CssClass="buttongrid" ItemStyle-HorizontalAlign="Left" 
                    ItemStyle-CssClass="copy10grey" ItemStyle-Width="8%">
                    <ItemTemplate>
