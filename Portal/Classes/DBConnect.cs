...
namespace avii.Classes
{
    ...
    public class DBConnect : IDisposable
	{
		...
		public DBConnect()
		{	
            if (System.Configuration.ConfigurationManager.ConnectionStrings["SQLConnectionString"].ConnectionString != null)
            {
            ...
            if (System.Configuration.ConfigurationManager.ConnectionStrings["SQLConnectionString"].ConnectionString != null)
            {
                ConnectionString2 = System.Configuration.ConfigurationManager.ConnectionStrings["SQLConnectionString"].ConnectionString;
            }
            else
            {
                throw new Exception("Connection string is not initialized");
            ...
            if (System.Configuration.ConfigurationManager.ConnectionStrings["SQLConnectionString"].ConnectionString != null)
            {
                ConnectionString3 = System.Configuration.ConfigurationManager.ConnectionStrings["SQLConnectionString"].ConnectionString;
            }
            else
            {
                throw new Exception("Connection string is not initialized");
