...
{
    public class ShippingLabelOperation
    {
        ...
        public static List<ShippingLabel> GetLabelList(int userId, int companyID)
        {
        ...
        public static string GetLabelBase64(int lineNumber, out string shipMethod, out string ShipPackage)
        {
        ...
        //}
        public static List<CustomValues> GetCustomdeclarations(int POID)
        {
            List<CustomValues> CustomValueList = new List<CustomValues>();
        ...
        private static List<CustomValues> PopulateCustomValues(DataTable dataTable)
        {
            List<CustomValues> CustomValueList = new List<CustomValues>();
        ...
        private static List<ShippingLabel> PopulateLabelInfo(DataTable dataTable)
        {
            List<ShippingLabel> labelList = new List<ShippingLabel>();
        ...
        public static ShippingLabelResponse ShippingLabelUpdate(ShippingLabelInfo request, int userId, List<FulfillmentShippingLineItem> listitems, string ShipDate, string Package, string ShipVia, decimal Weight, string Comments, decimal FinalPostage, bool IsManualTracking)
        {
        ...
        private static ShippingLabelResponse ShippingLabelUpdateDB(ShippingLabelInfo shippingLabelInfo, int UserID, List<FulfillmentShippingLineItem> listitems, string ShipDate, string Package, string ShipVia, decimal Weight, string Comments, decimal FinalPostage, bool IsManualTracking)
        {
        ...
        public static ShippingLabelResponse ShippingLabelUpdateNew(ShippingLabelInfo request, int userId, List<FulfillmentShippingLineItem> listitems, string ShipDate, string Package, string ShipVia, decimal Weight, string Comments, decimal FinalPostage, bool IsManualTracking, int poid, List<CustomValues> customValues)
        {
