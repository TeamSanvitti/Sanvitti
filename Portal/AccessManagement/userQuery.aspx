<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userQuery.aspx.cs" Inherits="avii.RoleMgmt.userQuery" ValidateRequest="false"%>
...
<link href="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.9/themes/start/jquery-ui.css"
	...
	<link rel="stylesheet" href="../dhtmlxwindow/style12.css" type="text/css" media="screen" />
    ...
    function openpopup(userid) {
		...
		w1 = dhxWins.createWindow("w1", 320, 125, 350, 200);
...
<body bgcolor="#ffffff" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <tr>
     ...
     <div id="winVP" style="z-index:1" >
        <table align="center" style="text-align:left" width="85%">
               <tr ><td> &nbsp;</td></tr>
              <tr class="button"><td class="style19">&nbsp;User Query</td></tr>
              <tr><td colspan=4>
            <asp:Label ID="lbl_message" runat="server" style="text-align: left" 
                    CssClass="errormessage"></asp:Label>
     </td></tr>
               <tr><td> 
          <asp:Panel ID="pnlUser" runat="server" DefaultButton="btn_searchuser">
    ...
    <tr><td class="copy10grey" width="15%">User:</td><td width="35%">
        ...
        <td class="copy10grey"  width="15%">Account Type:</td>
        <td  width="35%">
        <asp:DropDownList ID="ddlType" runat="server" Height="22px" Width="80%" 
                CssClass="copy10grey">
        ...
        </tr><tr><td class="copy10grey" >Roles:</td><td >
    ...
    <tr height="200" valign="top">
        <td>
            ...
            <asp:GridView ID="GV_User" PageSize="20" AllowPaging="true" runat="server" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="User name" HeaderStyle-CssClass="button" HeaderStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Email" HeaderStyle-CssClass="button" HeaderStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Company" HeaderStyle-CssClass="button" HeaderStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Co. A/C #" HeaderStyle-CssClass="button" HeaderStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
                            <asp:Label ID="lblACStatus" CssClass="copy10grey" runat="server" Text='<%#Eval("companyAccno")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="A/C Status" HeaderStyle-CssClass="button" HeaderStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Role" HeaderStyle-CssClass="button" HeaderStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
