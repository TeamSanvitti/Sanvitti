    ...
    public class DishLabelOperation
    {
        ...
        public MemoryStream PalletLabelPdfTarCode(IList<PalletModel> pallets)
        {
            ...
            foreach (var palletInfo in pallets)
            {
                ...
                addCellwithPaddingLeftSize(table, "Ship To: ", 0.5f, 0f, 25f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 18);
                addCellwithPaddingLeft50(table, "Ship From: ", 0.5f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 18);
                pdfDoc.Add(table);
                ...
                table.SetWidths(widths);
                table.HorizontalAlignment = Element.ALIGN_CENTER;
                addCellwithPaddingLeftSize(table, palletInfo.CustomerName, 0f, 0f, 25f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 18);
                addCellwithPaddingLeft50(table, "Lan Global Inc.", 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 14);
                pdfDoc.Add(table);
                ...
                if (string.IsNullOrEmpty(palletInfo.ShippingAddressLine2))
                    addCellwithPaddingLeftSize(table, palletInfo.ShippingAddressLine1, 0f, 0f, 25f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 18);
                else
                    addCellwithPaddingLeftSize(table, palletInfo.ShippingAddressLine1 + ", " + palletInfo.ShippingAddressLine2, 0f, 0f, 25f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 18);

                if (string.IsNullOrEmpty(palletInfo.AddressLine2))
                    addCellwithPaddingLeft50(table, palletInfo.AddressLine1, 0f, 0f, 0.5f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 18);
                else
                    addCellwithPaddingLeft50(table, palletInfo.AddressLine1 + ", " + palletInfo.AddressLine2, 0f, 0f, 0.5f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 18);
                ...
                addCellwithPaddingLeftSize(table, palletInfo.ShippingCity + " " + palletInfo.ShippingState + " " + palletInfo.ShippingZipCode, 0f, 0f, 25f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 18);

                addCellwithPaddingLeft50(table, palletInfo.City + " " + palletInfo.State + " " + palletInfo.ZipCode, 0f, 0f, 0.5f, 0f, BaseColor.WHITE, BaseColor.BLACK, 18);
                pdfDoc.Add(table);
        ...
        public MemoryStream MasterCartonLabelPdfTarCode(IList<MasterCartonInfo> cartons)
        {
            ...
            foreach (var cartonInfo in cartons)
            {
                ...
                PdfPCell cell2 = null;
                cell2 = new PdfPCell();
                addCellwithborderPaddingSize(table, "SKU: " + cartonInfo.SKU, 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 40f, 18f, 2, 20);
                ...
                if (UPCImage != null)
                {
                    cell11 = ImageCellNew22(UPCImage, 220f, PdfPCell.ALIGN_LEFT, 20f, 52f);
                    //cell11 = ImageCellNewLeft(UPCImage, 220f, PdfPCell.ALIGN_LEFT);
                    cell11.BorderWidthRight = 0.5f;
                    cell11.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                    table.AddCell(cell11);
                ...
                addCellwithborderPaddingSize(table, "Carton Qty: " + cartonInfo.CartonQty, 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 40f, 18f, 0, 14);
                pdfDoc.Add(table);
                ...
                addCellwithborderPaddingSize(table, "SW Version: " + cartonInfo.SWVersion, 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 20f, 13f, 0, 14);
                ...
                if (CartonQtyImage != null)
                {
                    ...
                    cell12 = ImageCellNewLeft(CartonQtyImage, 220f, PdfPCell.ALIGN_LEFT, 28f, 25f, 0);
                    cell12.BorderWidthRight = 0.5f;
                    cell12.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                    table.AddCell(cell12);
                ...
                table.HorizontalAlignment = Element.ALIGN_LEFT;
                table.SetWidths(widths);
                addCellwithborderPaddingSize(table, "HW Version: " + cartonInfo.HWVersion, 0f, 0f, 0.5f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 20f, 5, 5, 14);
                addCellwithborderPaddingSize(table, "Date: " + cartonInfo.ShipDate, 0f, 0f, 0.5f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 30f, 5, 5, 14);
        ...
        public MemoryStream BOXLabelPdfTarCode(IList<CartonBoxID> boxIDs)
        {
            ...
            foreach (var cartonInfo in boxIDs)
            {
                ...
                table.HorizontalAlignment = Element.ALIGN_LEFT;
                table.SetWidths(widths);
                addCellwithPaddingLeftBottomTopRightSize(table, cartonInfo.BoxID, 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 10f, 0f, 0f, 1f, 84f, 84f);
                ...
                table.HorizontalAlignment = Element.ALIGN_LEFT;
                table.SetWidths(widths);
                addCellwithPaddingLeftBottomTopRightSizeBolD(table, "Apple_A1863_UL_64gb_Grey",  0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 10f, 1f, 1f, 1f, 17f, 48f);
