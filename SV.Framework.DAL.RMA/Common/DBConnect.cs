...
namespace SV.Framework.DAL.RMA
{
    ...
    public class DBConnect : IDisposable
	{
        ...
        public DataTable GetTableRecords(Hashtable HshParameters, string SQLString, string[] arrFieldsSeq, string sOutParam1, string sOutParam2, string sOutParam3,
           string sOutParam4, string sOutParam5, string sOutParam6, string sOutParam7, string sOutParam8, string sOutParam9, out string sCode1, out string sCode2, out string sCode3, out bool sCode4, out bool sCode5, out int returnResult, out string sCode6, out string sCode7, out string sCode8, out string sCode9)
        {
            returnResult = 0;
            sCode4 = false;
            sCode5 = false;
