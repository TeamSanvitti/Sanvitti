    ...
    public class H5LabelOperation
    {
        ...
        public MemoryStream POSKITLabelPdfTarCode(IList<PosKitInfo> posKitS)
        {
            ...
            foreach (var cartonInfo in posKitS)
            {
                ...
                if (!string.IsNullOrEmpty(cartonInfo.IMEI2))
                {
                    //MEIDImage = GenerateBarCode(cartonInfo.MEID);
                    IMEI2Image = GenerateBarCodeTarCode(cartonInfo.IMEI2, 9.24f, 1.359f, 3f, 2f);
                ...
                //addCellwithPaddingLeftPaddingBottomSize(table, "", 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 1, 14f);
                addCellwithPaddingLeftBottomTopRightSize(table, "IMEI2: " + cartonInfo.IMEI2, 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 10f, 0f, 4f, 1f, 12f, 16f);
                ...
                if (IMEI2Image != null)
                {
                    ...
                    cell211 = ImageCellNew022(IMEI2Image, 170f, PdfPCell.ALIGN_LEFT, 0f, 24f);
                ...
                table.LockedWidth = true;
                table.DefaultCell.Border = Rectangle.NO_BORDER;
                widths = new float[] { 230f, 190f, 150f };
                ...
                addCellwithPaddingLeftBottomTopRightSize(table, "IMEI1: " + cartonInfo.ESN, 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 10f, 4f, 1f, 1f, 12f, 28f);
                ...
                addCellwithPaddingLeftBottomTopRightSize(table, "", 0f, 0f, 0f, 0.5f, BaseColor.WHITE, BaseColor.BLACK, 10f, 4f, 3f, 1f, 12f, 28f);
        ...
        public MemoryStream MasterCartonLabelPdfTarCode(IList<MasterCartonInfo> cartons)
        {
            ...
            foreach (var cartonInfo in cartons)
            {
                ...
                foreach (var item in cartonInfo.CartonItems)
                {
                    ...
                    if (cartonInfo.ProductType.ToLower() == "h5")
                    {
        ...
        public MemoryStream MasterCartonLabelPdfTarCodeOLD(IList<MasterCartonInfo> cartons)
        {
            var memoryStream = new MemoryStream();
            // ContainerModel ContainerInfo = new ContainerModel();
            float skuWarcodeWidth = 8.2f;
